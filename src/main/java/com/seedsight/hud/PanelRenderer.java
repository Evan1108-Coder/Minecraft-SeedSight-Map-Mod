...
import com.seedsight.calculator.McCalculator;
...
import com.seedsight.util.RenderUtil;
...
public class PanelRenderer {
    ...
    public PanelRenderer(SeedSightClient mod) {
        this.mod = mod;
    }
    ...
    public void renderPerfStats(DrawContext ctx, TextRenderer font, int x, int y, int w, int h) {
        ...
        drawStatLine(ctx, font, x + PAD, ty, w - PAD * 2,
                "MC", com.seedsight.ModVersion.MC_VERSION, labelColor, ColorUtil.DARK_GRAY);
    }
